...
export default function Hero() {
  return (
      <section className='container mt-12 flex w-screen flex-col items-center self-center justify-center'>
        <div className='flex flex-col max-w-[1200px] items-center justify-center lg:flex-row'>
          <div className='flex flex-col w-[300px] mobilemd:w-[360px] tablet:w-[540px] sm:w-[600px] items-center gap-2 justify-evenly'>
            <h1 className='max-w-[400px] text-3xl mobilemd:text-4xl text-center font-bold'>
            ...
            <div className='mt-4  flex flex-col w-full items-center gap-3'>
          ...
          <Heropic className='flex h-auto w-[300px] sm:w-[600px]'/>
        </div>
